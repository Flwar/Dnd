...
export const characterRaces: CharacterRace[] = [
  {
    ...
    attributeEffects: { charisma: 1, constitution: 1 }, recommendedClasses: ["fighter", "cleric", "rogue"], portraitKeys: ["portrait-human-01", "portrait-human-02", "portrait-human-03", "portrait-human-04"], gameplayEffect: "מקבל תוסף 1 לבדיקות מיומנות ללא הכשרה."
  },
  {
    ...
    attributeEffects: { dexterity: 2, wisdom: 1 }, recommendedClasses: ["ranger", "mage", "rogue"], portraitKeys: ["portrait-elf-01", "portrait-elf-02", "portrait-elf-03", "portrait-elf-04"], gameplayEffect: "זוכה ביתרון בבדיקת תפיסה הראשונה בכל מיקום אפל."
  },
  {
    ...
    attributeEffects: { constitution: 2, strength: 1 }, recommendedClasses: ["fighter", "cleric", "barbarian"], portraitKeys: ["portrait-dwarf-01", "portrait-dwarf-02", "portrait-dwarf-03", "portrait-dwarf-04"], gameplayEffect: "נזק מתמשך משחיתות מופחת בנקודה אחת לכל ערימה."
  },
  {
    ...
    attributeEffects: { dexterity: 2, charisma: 1 }, recommendedClasses: ["rogue", "ranger", "cleric"], portraitKeys: ["portrait-halfling-01", "portrait-halfling-02", "portrait-halfling-03", "portrait-halfling-04"], gameplayEffect: "תוצאת 1 טבעית ראשונה בסצנה מוטלת מחדש באופן אוטומטי."
  },
  {
    ...
    attributeEffects: { strength: 2, constitution: 1 }, recommendedClasses: ["barbarian", "fighter", "ranger"], portraitKeys: ["portrait-orc-01", "portrait-orc-02", "portrait-orc-03", "portrait-orc-04"], gameplayEffect: "שורד מכה קטלנית אחת בכל קרב עם נקודת חיים אחת."
  },
  {
    ...
    attributeEffects: { strength: 1, charisma: 2 }, recommendedClasses: ["fighter", "barbarian", "mage"], portraitKeys: ["portrait-dragonborn-01", "portrait-dragonborn-02", "portrait-dragonborn-03", "portrait-dragonborn-04"], gameplayEffect: "מקבל פעולת נשימה חד־פעמית הגורמת נזק אש ומצב בערה."
  },
];
