...
בסך הכול קיימות 144 רשומות איור במניפסט המקומי, ועוד `public/og.png` כתמונת מקור לשיתוף החברתי. שכבות 1.2.0 ו־1.3.0 הן המקור הקנוני לסצנות, לדיוקנאות, לאיורי המקצוע ולסמלי המלך; נכסי rebuild שנותרו משמשים אייקוני תוכן ותאימות בלבד.
