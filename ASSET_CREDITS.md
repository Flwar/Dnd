...
- שינויים כלליים: פיצול אטלסים, חיתוך ממוקד, התאמת צבע עדינה, חידוד, שינוי גודל ודחיסת WebP באמצעות Sharp (`effort: 6`, ‏smart subsampling). רקעים רחבים נשמרו ב־1024×576, גרסאות מובייל ב־576×720, דיוקנאות ב־288×360 ואייקונים ב־160×160.
